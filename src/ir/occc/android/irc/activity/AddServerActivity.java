...
import ir.occc.android.irc.exception.ValidationException;
import ir.occc.android.model.Authentication;
import ir.occc.android.model.Extra;
import ir.occc.android.model.Identity;
...
public class AddServerActivity extends SherlockActivity implements OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.irc_serveradd);
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        inflater.inflate(R.menu.irc_addserver, menu);
