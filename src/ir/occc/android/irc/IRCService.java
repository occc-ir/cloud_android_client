...
import ir.occc.android.ServersActivity;
...
public class IRCService extends Service
{
	...
	private void handleCommand(Intent intent)
    {
        if (ACTION_FOREGROUND.equals(intent.getAction())) {
            ...
            notification = new Notification(R.drawable.ic_launcher, getText(R.string.notification_running), System.currentTimeMillis());
